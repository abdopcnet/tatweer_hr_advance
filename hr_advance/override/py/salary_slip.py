...
class overrid_salary_slip(SalarySlip):
	...
	def set_salary_structure_assignment(self):
		...
		try:
			...
			designation_type = frappe.get_doc("Designation Type" , employee.custom_designation_type)
			...
			if designation:
				if designation.custom_is_it_a_leadership_position:
					...
					print(e)
					frappe.msgprint("Can not fetch Bonus Value value from Employee Designation Info")
					frappe.msgprint(e)
